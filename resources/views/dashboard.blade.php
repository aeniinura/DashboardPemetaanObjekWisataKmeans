<x-app-layout>
    ...
    <style>
     #mapid { height: 600px; }
   /* Kartu dengan latar belakang kuning dengan efek gradasi dan opacity */
    .card.yellow-background {
        background: linear-gradient(135deg, rgba(249, 231, 159, 0.8), rgba(255, 223, 95, 0.9)); /* Gradasi kuning lembut dengan transparansi */
        border: 1px solid rgba(255, 204, 63, 0.6); /* Border transparan dengan gradasi kuning */
    ...
    /* Kartu dengan latar belakang hijau dengan efek gradasi dan opacity */
    .card.green-background {
        background: linear-gradient(135deg, rgba(168, 213, 186, 0.8), rgba(129, 199, 132, 0.9)); /* Gradasi hijau pastel dengan transparansi */
        border: 1px solid rgba(129, 199, 132, 0.6); /* Border transparan dengan gradasi hijau */
        border-radius: 8px; /* Sudut melengkung */
        box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); /* Bayangan halus */
        transition: transform 0.3s ease, box-shadow 0.3s ease; /* Efek transisi */
    }

    .card.green-background:hover {
        transform: translateY(-5px); /* Efek sedikit naik saat hover */
        box-shadow: 0 8px 20px rgba(0, 0, 0, 0.15); /* Bayangan lebih besar saat hover */
    }

    /* Kartu dengan latar belakang merah muda dengan efek gradasi dan opacity */
    .card.red-background {
        background: linear-gradient(135deg, rgba(245, 183, 177, 0.8), rgba(241, 148, 138, 0.9)); /* Gradasi merah muda pastel dengan transparansi */
        border: 1px solid rgba(241, 148, 138, 0.6); /* Border transparan dengan gradasi merah muda */
        border-radius: 8px; /* Sudut melengkung */
        box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); /* Bayangan halus */
        transition: transform 0.3s ease, box-shadow 0.3s ease; /* Efek transisi */
    }

    .card.red-background:hover {
        transform: translateY(-5px); /* Efek sedikit naik saat hover */
        box-shadow: 0 8px 20px rgba(0, 0, 0, 0.15); /* Bayangan lebih besar saat hover */
    }

    /* Menambahkan box-sizing agar padding dan border dihitung dalam lebar dan tinggi elemen */
*,
*::before,
*::after {
...
/* Tabel dengan desain hitam-putih elegan */
table {
    width: 100%;
    border-collapse: collapse; /* Menghilangkan ruang antar border */
...
.table-container {
    ...
    border: 1px solid #000; /* Border hitam untuk kontainer tabel */
    border-radius: 8px; /* Sudut melengkung untuk efek modern */
    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* Bayangan halus */
}

/* Gaya untuk elemen th dan td */
th, td {
    border: 1px solid #000; /* Border hitam untuk tabel */
    padding: 12px 15px; /* Memberikan ruang pada teks */
    text-align: left; /* Penataan teks rata kiri */
    white-space: nowrap; /* Mencegah teks membungkus */
    background-color: #fff; /* Latar belakang putih untuk setiap sel tabel */
    color: #000; /* Teks hitam untuk kontras */
    transition: background-color 0.3s, color 0.3s; /* Transisi lembut untuk hover */
}
...
tr:nth-child(even) {
    background-color: #fff; /* Latar belakang putih untuk baris genap */
}

/* Efek hover pada baris */
tr:hover {
    background-color: #f1f1f1; /* Memberikan latar belakang putih keabu-abuan lebih gelap saat hover */
    cursor: pointer; /* Menambahkan kursor pointer untuk interaktivitas */
}

/* Efek hover pada sel tabel */
th:hover, td:hover {
    background-color: #f1f1f1; /* Latar belakang putih keabu-abuan lebih gelap saat hover */
    color: #000; /* Mengubah warna teks menjadi hitam saat hover */
}


/* Desain Card dengan nuansa hitam-putih elegan */
.card {
    background-color: #fff; /* Latar belakang putih bersih */
    border: 1px solid #000; /* Border hitam untuk kartu */
    border-radius: 8px; /* Sudut melengkung */
    padding: 20px;
...
.card:hover {
    transform: translateY(-5px); /* Efek sedikit naik saat hover */
    box-shadow: 0 8px 15px rgba(0, 0, 0, 0.15); /* Bayangan lebih besar saat hover */
}
...
/* Card content */
.card-content {
    color: #000; /* Teks konten hitam */
}

/* Efek hover pada Card */
.card:hover {
    background-color: #f1f1f1; /* Background berubah saat hover */
}
